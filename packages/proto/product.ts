...
export interface ProductServiceController {
  ...
  productManagement(request: ProductCount): Promise<ProductCount> | Observable<ProductCount> | ProductCount;
...
export function ProductServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["createProduct", "findOne", "productManagement"];
